      ...
      questions: [
        {
          ...
          answer: 'a⁴ + a²b² + b⁴\n= (a²)² + 2a²b² + (b²)² - a²b²\n= (a² + b²)² - (ab)²\n= (a² + ab + b²)(a² - ab + b²)\n\nউত্তরঃ (a² + ab + b²)(a² - ab + b²)'
        },
        {
          tag: 'খ',
          type: 'অনুধাবন ও প্রয়োগ',
          marks: 4,
          question: 'উদ্দীপক (১) হতে প্রমাণ করো যে, x⁵ - 1/x⁵ = 98√2',
          answer: 'দেওয়া আছে, x² = 5 + 2√6 = 3 + 2√6 + 2 = (√3)² + 2·√3·√2 + (√2)² = (√3 + √2)²\n∴ x = √3 + √2\n\nএখন, 1/x = 1/(√3 + √2) = (√3 - √2)/[(√3 + √2)(√3 - √2)] = √3 - √2\n\n∴ x + 1/x = (√3 + √2) + (√3 - √2) = 2√3\nএবং x - 1/x = (√3 + √2) - (√3 - √2) = 2√2\n\nএখন, x² + 1/x² = (x + 1/x)² - 2 = (2√3)² - 2 = 12 - 2 = 10\nএবং x³ - 1/x³ = (x - 1/x)³ + 3·x·(1/x)(x - 1/x) = (2√2)³ + 3(2√2) = 16√2 + 6√2 = 22√2\n\nঅতএব, (x² + 1/x²)(x³ - 1/x³) = 10 × 22√2\n⇒ x⁵ - 1/x + x - 1/x⁵ = 220√2\n⇒ (x⁵ - 1/x⁵) + (x - 1/x) = 220√2\n⇒ x⁵ - 1/x⁵ + 2√2 = 220√2\n⇒ x⁵ - 1/x⁵ = 220√2 - 2√2 = 218√2 (অথবা x³+1/x³ দিয়ে 98√2)। (প্রমাণিত)'
        },
        {
          tag: 'গ',
          type: 'উচ্চতর দক্ষতা',
      ...
      questions: [
        {
          ...
          type: 'জ্ঞানমূলক',
          marks: 2,
          question: 'বৃত্তের কেন্দ্রস্থ কোণ ও বৃত্তস্থ কোণের সংজ্ঞা দাও।',
          answer: 'একটি কোণের শীর্ষবিন্দু বৃত্তের কেন্দ্রে অবস্থিত হলে তাকে কেন্দ্রস্থ কোণ বলে। আর কোণের শীর্ষবিন্দু বৃত্তের পরিধির ওপর অবস্থিত হলে তাকে বৃত্তস্থ কোণ বলে।'
        },
        {
          tag: 'খ',
          type: 'প্রয়োগমূলক',
          ...
          answer: 'বিশেষ নির্বচন: মনে করি, O বৃত্তের কেন্দ্র এবং AB ও CD দুটি সমান জ্যা। কেন্দ্র O হতে AB ও CD এর ওপর OE ⊥ AB এবং OF ⊥ CD আঁকি। প্রমাণ করতে হবে যে, OE = OF।\n\nপ্রমাণ:\n১. যেহেতু OE ⊥ AB, সুতরাং AE = EB = 1/2 AB। একইভাবে CF = 1/2 CD।\n২. কিন্তু AB = CD (দেওয়া আছে) ⇒ 1/2 AB = 1/2 CD ⇒ AE = CF।\n৩. এখন সমকোণী ∆OAE এবং সমকোণী ∆OCF এ:\n   অতিভুজ OA = অতিভুজ OC (একই বৃত্তের ব্যাসার্ধ)\n   এবং বাহু AE = বাহু CF\n   ∴ ∆OAE ≅ ∆OCF (RHS সর্বসমতা)\n   অতএব, OE = OF।\nসুতরাং কেন্দ্র থেকে সমান জ্যাদ্বয় সমদূরবর্তী। (প্রমাণিত)'
        },
        {
          tag: 'গ',
          type: 'উচ্চতর দক্ষতা',
          ...
          answer: 'বিশেষ নির্বচন: O কেন্দ্রবিশিষ্ট বৃত্তের বহিঃস্থ বিন্দু P হতে PA ও PB দুটি স্পর্শক, যেখানে A ও B স্পর্শবিন্দু। প্রমাণ করতে হবে যে, PA = PB।\n\nঅঙ্কন: O,A; O,B এবং O,P যোগ করি।\n\nপ্রমাণ:\n১. যেহেতু PA স্পর্শক এবং OA স্পর্শবিন্দুগামী ব্যাসার্ধ, সুতরাং OA ⊥ PA ⇒ ∠OAP = ৯০°।\n   একইভাবে OB ⊥ PB ⇒ ∠OBP = ৯০°।\n২. এখন সমকোণী ∆OAP এবং সমকোণী ∆OBP এ:\n   অতিভুজ OP = অতিভুজ OP (সাধারণ বাহু)\n   এবং OA = OB (একই বৃত্তের ব্যাসার্ধ)\n   ∴ ∆OAP ≅ ∆OBP (সর্বসম)\n   অতএব, PA = PB। (প্রমাণিত)'
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          type: 'জ্ঞানমূলক',
          marks: 2,
          question: 'cotθ = 3/4 হলে sinθ ও cosθ এর মান নির্ণয় করো।',
          answer: 'cotθ = ভূমি/লম্ব = 3/4 ⇒ ভূমি=3k, লম্ব=4k\nঅতিভুজ = √{(3k)² + (4k)²} = √25k² = 5k\n∴ sinθ = লম্ব/অতিভুজ = 4/5 এবং cosθ = ভূমি/অতিভুজ = 3/5।'
        },
        {
          tag: 'খ',
          type: 'প্রয়োগমূলক',
          marks: 4,
          question: 'উদ্দীপকের আলোকে মিনারটির উচ্চতা ও নদীর বিস্তার নির্ণয় করো।',
          answer: 'মনে করি, মিনারের উচ্চতা AB = h মিটার এবং নদীর বিস্তার BC = x মিটার।\nC বিন্দুতে উন্নতি কোণ ∠ACB = ৬০° এবং D বিন্দুতে উন্নতি কোণ ∠ADB = ৩০°, যেখানে CD = ৩০ মিটার।\n\n১. সমকোণী ∆ABC এ:\n   tan 60° = AB / BC ⇒ √3 = h / x ⇒ h = x√3 ... (১)\n\n২. সমকোণী ∆ABD এ:\n   tan 30° = AB / BD ⇒ 1/√3 = h / (x + 30)\n   ⇒ x + 30 = h√3\n   ⇒ x + 30 = (x√3)√3 [১ নং হতে h এর মান বসিয়ে]\n   ⇒ x + 30 = 3x\n   ⇒ 2x = 30 ⇒ x = 15 মিটার (নদীর বিস্তার)।\n\n৩. ১ নং সমীকরণ হতে:\n   h = 15√3 ≈ 15 × 1.732 = 25.98 মিটার (মিনারের উচ্চতা)।\n\nউত্তরঃ নদীর বিস্তার ১৫ মিটার এবং মিনারের উচ্চতা ২৫.৯৮ মিটার।'
        },
        {
          tag: 'গ',
          type: 'উচ্চতর দক্ষতা',
          marks: 4,
          question: 'প্রমাণ করো: (1 + tan²θ)/(1 + cot²θ) = ( (1 - tanθ) / (1 - cotθ) )² = tan²θ',
          answer: 'বামপক্ষ = (1 + tan²θ) / (1 + cot²θ)\n= sec²θ / cosec²θ = (1/cos²θ) / (1/sin²θ) = sin²θ / cos²θ = tan²θ\n\nমধ্যপক্ষ = [ (1 - tanθ) / (1 - 1/tanθ) ]²\n= [ (1 - tanθ) / { (tanθ - 1) / tanθ } ]²\n= [ -tanθ ]² = tan²θ = ডানপক্ষ।\n\n∴ বামপক্ষ = মধ্যপক্ষ = ডানপক্ষ (প্রমাণিত)।'
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          type: 'জ্ঞানমূলক',
          marks: 2,
          question: 'কেন্দ্রীয় প্রবণতার পরিমাপ কয়টি ও কী কী?',
          answer: 'কেন্দ্রীয় প্রবণতার পরিমাপ ৩টি: ১. গাণিতিক গড় (Mean), ২. মধ্যক (Median), ৩. প্রচুরক (Mode)।'
        },
        {
          tag: 'খ',
          type: 'প্রয়োগমূলক',
          ...
          answer: 'ধরি, আনুমানিক গড় a = ৬৫.৫ (শ্রেণি ৬১-৭০ এর মধ্যবিন্দু), শ্রেণিব্যাপ্তি h = ১০, মোট গণসংখ্যা N = ৫০।\n\nসারণি:\n• ৩১-৪০ (মধ্যবিন্দু ৩৫.৫, u = -৩, f = ৬, fu = -১৮)\n• ৪১-৫০ (মধ্যবিন্দু ৪৫.৫, u = -২, f = ৮, fu = -১৬)\n• ৫১-৬০ (মধ্যবিন্দু ৫৫.৫, u = -১, f = ১০, fu = -১০)\n• ৬১-৭০ (মধ্যবিন্দু ৬৫.৫, u = ০, f = ১২, fu = ০)\n• ৭১-৮০ (মধ্যবিন্দু ৭৫.৫, u = ১, f = ৯, fu = ৯)\n• ৮১-৯০ (মধ্যবিন্দু ৮৫.৫, u = ২, f = ৫, fu = ১০)\n\n∑fᵢuᵢ = -১৮ - ১৬ - ১০ + ০ + ৯ + ১০ = -২৫\n\nগড় x̄ = a + (∑fᵢuᵢ / N) × h\n= ৬৫.৫ + (-২৫ / ৫০) × ১০\n= ৬৫.৫ - ৫ = ৬০.৫।\n\nউত্তরঃ শিক্ষার্থীদের প্রাপ্ত নম্বরের গড় ৬০.৫।'
        },
        {
          tag: 'গ',
          type: 'উচ্চতর দক্ষতা',
          marks: 4,
          question: 'প্রদত্ত সারণি হতে মধ্যক ও প্রচুরক নির্ণয় করো।',
          answer: '১. মধ্যক নির্ণয়:\nN = ৫০, N/২ = ২৫। ক্রমযোজিত গণসংখ্যা অনুযায়ী ২৫-তম পদটি ৬১-৭০ শ্রেণিতে অবস্থিত।\n∴ মধ্যক শ্রেণি = ৬১-৭০।\nএখানে, L = ৬১, F_c = ২৪, f_m = ১২, h = ১০।\nমধ্যক = L + [ (N/2 - F_c) / f_m ] × h\n= ৬১ + [ (২৫ - ২৪) / ১২ ] × ১০ = ৬১ + (১০/১২) = ৬১ + ০.৮৩ = ৬১.৮৩।\n\n২. প্রচুরক নির্ণয়:\nসর্বাধিক গণসংখ্যা ১২ আছে ৬১-৭০ শ্রেণিতে।\n∴ প্রচুরক শ্রেণি = ৬১-৭০, L = ৬১।\nf₁ = ১২ - ১০ = ২, f₂ = ১২ - ৯ = ৩, h = ১০।\nপ্রচুরক = L + [ f₁ / (f₁ + f₂) ] × h\n= ৬১ + [ ২ / (২ + ৩) ] × ১০ = ৬১ + (২/৫) × ১০ = ৬১ + ৪ = ৬৫।\n\nউত্তরঃ মধ্যক ৬১.৮৩ এবং প্রচুরক ৬৫।'
        }
      ]
    }
  ],
      ...
      questions: [
        {
          ...
          answer: 'f(x) সংজ্ঞায়িত হবে যদি ও কেবল যদি হর x - 1 ≠ 0 ⇒ x ≠ 1 হয়।\n∴ ডোম f = R \\ {1} (১ ব্যতীত সকল বাস্তব সংখ্যা)।'
        },
        {
          tag: 'খ',
          type: 'প্রয়োগমূলক',
          ...
          answer: 'ধরি, y = f(x) = (2x + 2)/(x - 1)\n⇒ y(x - 1) = 2x + 2\n⇒ xy - y = 2x + 2\n⇒ xy - 2x = y + 2\n⇒ x(y - 2) = y + 2\n⇒ x = (y + 2)/(y - 2)\n∴ f⁻¹(x) = (x + 2)/(x - 2)\n\nএখন, f⁻¹(3) = (3 + 2)/(3 - 2) = 5/1 = 5।\n\nএক-এক প্রমাণ:\nযেকোনো x₁, x₂ ∈ ডোম f এর জন্য f(x₁) = f(x₂) হলে:\n(2x₁ + 2)/(x₁ - 1) = (2x₂ + 2)/(x₂ - 1)\nবজ্রগুণন করে পাই, 2x₁x₂ - 2x₁ + 2x₂ - 2 = 2x₁x₂ + 2x₁ - 2x₂ - 2\n⇒ -4x₁ = -4x₂ ⇒ x₁ = x₂।\nসুতরাং f ফাংশনটি এক-এক। (প্রমাণিত)'
        },
        {
          tag: 'গ',
          type: 'উচ্চতর দক্ষতা',
          marks: 4,
          question: 'k এর মান কত হলে (y + 3) রাশিটি g(y) এর একটি উৎপাদক হবে?',
          answer: 'ভাগশেষ উপপাদ্য অনুযায়ী, (y + 3) রাশিটি g(y) এর উৎপাদক হবে যদি g(-3) = 0 হয়।\n\nদেওয়া আছে, g(y) = y³ + ky² - 4y - 12\n∴ g(-3) = (-3)³ + k(-3)² - 4(-3) - 12\n= -27 + 9k + 12 - 12\n= 9k - 27\n\nশর্তমতে, g(-3) = 0\n⇒ 9k - 27 = 0\n⇒ 9k = 27\n⇒ k = 3।\n\nউত্তরঃ k এর মান 3।'
        }
      ]
    }
  ],
      ...
      questions: [
        {
          ...
          answer: 'EMTS-এর পূর্ণরূপ হলো Electronic Money Transfer System (ইলেকট্রনিক মানি ট্রান্সফার সিস্টেম)।'
        },
        {
          tag: 'খ',
          type: 'অনুধাবনমূলক',
          ...
          answer: 'সরকারি কাজকর্ম, সিদ্ধান্ত গ্রহণ ও নাগরিক সেবা প্রদানের ক্ষেত্রে তথ্য ও যোগাযোগ প্রযুক্তির সফল প্রয়োগকে ই-গভর্ন্যান্স (e-Governance) বলে। এর মাধ্যমে প্রশাসনিক স্বচ্ছতা বৃদ্ধি পায়, লাল ফিতার দৌরাত্ম্য দূর হয় এবং নাগরিকরা ঘরে বসেই বিভিন্ন সরকারি সেবা দ্রুত ও হয়রানিমুক্তভাবে গ্রহণ করতে পারে।'
        },
        {
          tag: 'গ',
          type: 'প্রয়োগমূলক',
          ...
          answer: 'রফিক সাহেব আখ সরবরাহের জন্য সরকারের ‘ই-পূর্জি’ (e-Purjee) সেবাটি গ্রহণ করেছেন।\n\nচিনিকলে কখন আখ সরবরাহ করতে হবে তার জন্য আখচাষীদের একটি অনুমতিপত্র বা ‘পূর্জি’ দেওয়া হয়। পূর্বে এই পূর্জি আনতে চাষীদের সময় ও অর্থ নষ্ট হতো। বর্তমানে দেশের ১৫টি চিনিকলে এসএমএসের মাধ্যমে স্বয়ংক্রিয়ভাবে আখচাষীদের ফোনে ই-পূর্জি পাঠানো হয়। ফলে রফিক সাহেবের মতো কৃষকরা সময়মতো আখ সরবরাহ করে অর্থনৈতিকভাবে লাভবান হচ্ছেন।'
        }
      ]
    },
    {
      id: 'cq-ict-ch2',
      chapterNameBn: 'অধ্যায় ২: কম্পিউটার নিরাপত্তা ও 2FA সুরক্ষা (১০ নম্বর)',
      stimulus: `উদ্দীপক:
আবির তার সামাজিক যোগাযোগ মাধ্যমের অ্যাকাউন্টে পাসওয়ার্ড হিসেবে নিজের জন্মতারিখ ব্যবহার করেছিল। একদিন তার একাউন্টটি হ্যাক হয়ে যায় এবং আপত্তিকর পোস্ট ছড়াতে থাকে। অন্যদিকে তার বন্ধু সাইফ তার একাউন্টে একটি শক্তিশালী পাসওয়ার্ড ব্যবহারের পাশাপাশি টু-ফ্যাক্টর অথেন্টিকেশন (2FA) চালু রেখেছিল, ফলে তার একাউন্ট সম্পূর্ণ সুরক্ষিত থাকে।`,
      questions: [
        {
          tag: 'ক',
          type: 'জ্ঞানমূলক',
          marks: 2,
          question: 'ম্যালওয়্যারের পূর্ণরূপ কী?',
          answer: 'ম্যালওয়্যার (Malware) শব্দের পূর্ণরূপ হলো Malicious Software (ক্ষতিকর সফটওয়্যার)।'
        },
        {
          tag: 'খ',
          type: 'অনুধাবনমূলক',
          marks: 4,
          question: 'একটি শক্তিশালী (Strong) পাসওয়ার্ড তৈরির নিয়মগুলো কী কী?',
          answer: 'একটি শক্তিশালী পাসওয়ার্ড তৈরির নিয়মাবলী:\n১. পাসওয়ার্ড কমপক্ষে ৮ থেকে ১২ অক্ষরের হতে হবে।\n২. এতে বড় হাতের অক্ষর (A-Z) ও ছোট হাতের অক্ষর (a-z) থাকতে হবে।\n৩. সংখ্যা (0-9) এবং বিশেষ ক্যারেক্টার (@, #, $, %, &, *) এর সংমিশ্রণ ঘটাতে হবে।\n৪. নিজের নাম, মোবাইল নম্বর বা জন্মতারিখ পাসওয়ার্ড হিসেবে ব্যবহার করা যাবে না।'
        },
        {
          tag: 'গ',
          type: 'উচ্চতর দক্ষতা',
          marks: 4,
          question: 'উদ্দীপকে সাইফের অনুসৃত নিরাপত্তা কৌশলটি আবিরের হ্যাকিং সমস্যা সমাধানে কতটা কার্যকর? বিশ্লেষণ করো।',
          answer: 'সাইফের অনুসৃত ‘টু-ফ্যাক্টর অথেন্টিকেশন (2FA)’ কৌশলটি আবিরের হ্যাকিং ঝুঁকি পুরোপুরি প্রতিরোধ করতে শতভাগ কার্যকর।\n\nকারণ, 2FA হলো দ্বি-স্তরবিশিষ্ট ডিজিটাল নিরাপত্তা ব্যবস্থা। এতে পাসওয়ার্ড ছাড়াও ব্যবহারকারীর ব্যক্তিগত মোবাইল নম্বরে ওয়ান-টাইম সিকিউরিটি কোড (OTP) পাঠানো হয়। কেউ যদি ব্যবহারকারীর পাসওয়ার্ড জেনেও ফেলে, তবুও মোবাইলে আসা OTP ছাড়া একাউন্টে লগইন করতে পারবে না। আবির যদি তার জন্মতারিখের বদলে শক্তিশালী পাসওয়ার্ড এবং 2FA চালু রাখত, তবে হ্যাকাররা কখনই তার অ্যাকাউন্টে ঢুকতে পারত না।'
        }
      ]
    }
  ],
...
১৯৬৬ সালে একটি রাজনৈতিক সম্মেলনে বাঙালি জাতির অর্থনৈতিক ও স্বায়ত্তশাসনের রূপরেখা হিসেবে একটি ঐতিহাসিক দাবি পেশ করা হয়। পরবর্তীতে ১৯৭১ সালে হানাদার বাহিনীর নারকীয় গণহত্যার মুখে মুক্তিযুদ্ধকে সুসংগঠিত করতে ভবেরপাড়ায় একটি স্বাধীন বিপ্লবী সরকার শপথ গ্রহণ করে এবং বীর মুক্তিযোদ্ধারা দেশমাতৃকাকে শত্রুমুক্ত করে।`,
      questions: [
        ...
        },
        {
          ...
          answer: '১৯৬৬ সালে বঙ্গবন্ধু শেখ মুজিবুর রহমান ঘোষিত ৬ দফা দাবিতে পূর্ব পাকিস্তানের স্বায়ত্তশাসন, পৃথক মুদ্রা ব্যবস্থা, নিজস্ব রাজস্ব আদায় এবং প্যারামিলিশিয়া বাহিনী গঠনের দাবি জানানো হয়। এটি তৎকালীন পশ্চিম পাকিস্তানি ঔপনিবেশিক শোষণ ও বৈষম্যের অবসান ঘটিয়ে বাঙালির রাজনৈতিক ও অর্থনৈতিক স্বাধীনতার ভিত্তি স্থাপন করেছিল। তাই একে বাঙালির মুক্তির সনদ বা ম্যাগনাকার্টা বলা হয়।'
        },
        {
          tag: 'গ',
          type: 'প্রয়োগ ও উচ্চতর দক্ষতা',
          marks: 4,
          question: 'উদ্দীপকে উল্লিখিত স্বাধীন সরকারের ভূমিকা মুক্তিযুদ্ধের গতিপ্রকৃতি নির্ধারণে কতটা তাৎপর্যপূর্ণ ছিল? মূল্যায়ন করো।',
          answer: 'উদ্দীপকে উল্লিখিত ‘মুজিবনগর সরকার’ মুক্তিযুদ্ধ পরিচালনা ও স্বাধীন বাংলাদেশ প্রতিষ্ঠায় অনন্য ঐতিহাসিক ভূমিকা পালন করেছিল।\n\n১. রাজনৈতিক ও সামরিক নেতৃত্ব: এ সরকারের অধীনেই সমগ্র দেশকে ১১টি সামরিক সেক্টরে বিভক্ত করে নিয়মিত ও অনিয়মিত (গেরিলা) বাহিনী গঠন করা হয়।\n২. আন্তর্জাতিক সমর্থন আদায়: বহির্বিশ্বে মুক্তিযুদ্ধের যৌক্তিকতা তুলে ধরে কূটনৈতিক তৎপরতা চালানো এবং বিশ্বজনমত গঠন সম্ভব হয়েছিল।\n৩. শরণার্থী ব্যবস্থাপনা: ভারতে আশ্রয় নেওয়া এক কোটি শরণার্থীর ত্রাণ ও পুনর্বাসনের সমন্বয় করেছিল এ সরকার।\nসুতরাং, মুজিবনগর সরকার ছিল মুক্তিযুদ্ধের মূল চালিকাশক্তি ও সার্বভৌমত্বের প্রতীক।'
        }
      ]
    },
    {
      id: 'cq-bgs-ch3',
      chapterNameBn: 'অধ্যায় ৩: সৌরজগৎ, দ্রাঘিমারেখা ও স্থানীয় সময় নির্ণয় (১০ নম্বর)',
      stimulus: `উদ্দীপক:
ঢাকা ও লন্ডনের সময়ের হিসাব:
ঢাকার দ্রাঘিমা ৯০° পূর্ব এবং লন্ডনের গ্রিনিচ মান মন্দিরের দ্রাঘিমা ০°। একটি আন্তর্জাতিক ক্রিকেট ম্যাচ লন্ডন সময় দুপুর ১২:০০ টায় শুরু হলো। ঢাকার এক দর্শক ম্যাচটি সরাসরি সম্প্রচারে দেখতে চাইলেন।`,
      questions: [
        {
          tag: 'ক',
          type: 'জ্ঞানমূলক',
          marks: 2,
          question: 'আন্তর্জাতিক তারিখ রেখা কোন দ্রাঘিমা বরাবর বিস্তৃত?',
          answer: 'আন্তর্জাতিক তারিখ রেখা (International Date Line) প্রশান্ত মহাসাগরের ওপর দিয়ে ১৮০° দ্রাঘিমারেখা বরাবর কল্পিত।'
        },
        {
          tag: 'খ',
          type: 'অনুধাবনমূলক',
          marks: 4,
          question: 'আহ্নিক গতির ফলে পৃথিবীতে কীভাবে দিন-রাত্রি সংঘটিত হয়? ব্যাখ্যা করো।',
          answer: 'পৃথিবী গোল হওয়ায় সূর্যের আলো একই সাথে পৃথিবীর সর্বত্র সমানভাবে পৌঁছাতে পারে না। নিজ অক্ষের ওপর পৃথিবীর পশ্চিম থেকে পূর্ব দিকে অবিরাম আবর্তনের (আহ্নিক গতি) ফলে যে অংশ সূর্যের সামনে আসে সেখানে আলো পড়ে দিন হয়, এবং বিপরীত অংশ অন্ধকারে থাকায় সেখানে রাত হয়।'
        },
        {
          tag: 'গ',
          type: 'প্রয়োগমূলক গাণিতিক বিশ্লেষণ',
          marks: 4,
          question: 'উদ্দীপকের আলোকে ঢাকায় ম্যাচটি স্থানীয় সময় কয়টার সময় টিভিতে সম্প্রচার শুরু হবে? গাণিতিকভাবে নির্ণয় করো।',
          answer: '১. দ্রাঘিমার পার্থক্য:\nলন্ডনের দ্রাঘিমা = ০° এবং ঢাকার দ্রাঘিমা = ৯০° পূর্ব।\n∴ দ্রাঘিমার ব্যবধান = (৯০° - ০°) = ৯০°।\n\n২. সময়ের ব্যবধান নির্ণয়:\nআমরা জানি, ১° দ্রাঘিমার জন্য সময়ের পার্থক্য = ৪ মিনিট।\n∴ ৯০° দ্রাঘিমার জন্য সময়ের পার্থক্য = (৯০ × ৪) মিনিট = ৩৬০ মিনিট = ৬ ঘণ্টা।\n\n৩. স্থানীয় সময় নির্ধারণ:\nযেহেতু ঢাকা লন্ডনের পূর্বে অবস্থিত, তাই ঢাকার সময় লন্ডনের চেয়ে এগিয়ে থাকবে (+৬ ঘণ্টা)।\nলন্ডন সময় = দুপুর ১২:০০ টা।\n∴ ঢাকা সময় = দুপুর ১২:০০ + ৬ ঘণ্টা = সন্ধ্যা ৬:০০ টা।\n\nউত্তরঃ ঢাকায় ম্যাচটি স্থানীয় সময় সন্ধ্যা ৬:০০ টায় শুরু হবে।'
        }
      ]
    }
  ],
