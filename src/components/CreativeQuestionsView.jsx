...
ঢাকার দ্রাঘিমা ৯০° পূর্ব এবং লন্ডনের গ্রিনিচ মান মন্দিরের দ্রাঘিমা ০°। একটি আন্তর্জাতিক ক্রিকেট ম্যাচ লন্ডন সময় দুপুর ১২:০০ টায় শুরু হলো। ঢাকার এক দর্শক ম্যাচটি সরাসরি সম্প্রচারে দেখতে চাইলেন।`,
  ...
  'general-science': [
    {
      id: 'cq-gsci-ch1',
      chapterNameBn: 'অধ্যায় ১ ও ৩: উন্নততর জীবনধারা ও রক্তের উপাদান (১০ নম্বর)',
      stimulus: `উদ্দীপক:
রকিবের ওজন ৮০ কেজি এবং উচ্চতা ১.৬০ মিটার। সম্প্রতি তিনি সামান্য পরিশ্রমে ক্লান্ত হয়ে পড়েন এবং বুক ধড়ফড় করে। ডাক্তার পরীক্ষা করে দেখলেন তার রক্তে খারাপ কোলেস্টেরল (LDL) বৃদ্ধি পেয়েছে এবং তাঁকে ওজন নিয়ন্ত্রণ ও খাদ্যভ্যাস পরিবর্তনের পরামর্শ দেন।`,
      questions: [
        {
          tag: 'ক',
          type: 'জ্ঞানমূলক',
          marks: 2,
          question: 'BMI-এর পূর্ণরূপ কী?',
          answer: 'BMI-এর পূর্ণরূপ হলো Body Mass Index (বডি ম্যাস ইনডেক্স বা দেহভর সূচক)।'
        },
        {
          tag: 'খ',
          type: 'অনুধাবনমূলক',
          marks: 4,
          question: 'রক্তের অনুচক্রিকাকে ‘রক্তের প্রহরী’ বলা হয় কেন? ব্যাখ্যা করো।',
          answer: 'শরীরের কোনো অংশ কেটে রক্তপাত হলে অনুচক্রিকা দ্রুত রক্ত জমাট বাঁধতে (Blood Clotting) সাহায্য করে। এটি থ্রম্বোপ্লাস্টিন নামক পদার্থ নিঃসরণ করে রক্ত জমাট বাঁধিয়ে প্রাণঘাতী রক্তক্ষরণ প্রতিরোধ করে দেহকে রক্ষা করে।'
        },
        {
          tag: 'গ',
          type: 'প্রয়োগ ও উচ্চতর দক্ষতা',
          marks: 4,
          question: 'উদ্দীপকের আলোকে রকিবের BMI নির্ণয় করো এবং তাঁর শারীরিক অবস্থা মূল্যায়ন করো।',
          answer: '১. BMI নির্ণয়:\nআমরা জানি, BMI = ওজন (কেজি) / [উচ্চতা (মিটার)]²\nদেওয়া আছে, ওজন = ৮০ কেজি, উচ্চতা = ১.৬০ মিটার।\n∴ BMI = ৮০ / (১.৬০)² = ৮০ / ২.৫৬ = ৩১.২৫ kg/m²।\n\n২. শারীরিক মূল্যায়ন:\nস্বাভাবিক BMI মান হলো ১৮.৫ – ২৪.৯। রকিবের BMI ৩১.২৫ যা ৩০-এর অধিক, অর্থাৎ তিনি ‘স্থূলতা’ (Obesity) বা অতিরিক্ত মেদের সমস্যায় আক্রান্ত। অতিরিক্ত চর্বি ও LDL কোলেস্টেরল হৃদপিণ্ডের রক্তনালীতে প্লাক তৈরি করে রক্ত চলাচল ব্যাহত করছে। নিয়মিত কায়িক পরিশ্রম, ব্যায়াম ও সুষম খাবার গ্রহণ করে ওজন কমানো তাঁর স্বাস্থ্যের জন্য জরুরি।'
        }
      ]
    }
  ],
      ...
      questions: [
        {
          ...
          answer: 'বস্তু যে অবস্থায় আছে চিরকাল সে অবস্থায় থাকতে চাওয়ার যে স্বাভাবিক প্রবণতা বা ধর্ম, তাকে জড়তা (Inertia) বলে।'
        },
        {
          tag: 'খ',
          type: 'অনুধাবনমূলক',
          ...
          answer: 'গতি জড়তার কারণে যাত্রীরা সামনের দিকে ঝুঁকে পড়েন। চলন্ত গাড়ির সাথে যাত্রীর সমগ্র শরীরও গতিশীল থাকে। যখন গাড়ি হঠাৎ ব্রেক কষে, তখন গাড়ির সাথে সংযুক্ত শরীরের নিম্নাংশ স্থির হয়ে যায় কিন্তু শরীরের ঊর্ধ্বাংশ গতি জড়তার কারণে সামনের দিকে চলতে চায়। ফলে যাত্রীরা সামনের দিকে ঝুঁকে পড়েন।'
        },
        {
          tag: 'গ',
          type: 'প্রয়োগমূলক গাণিতিক বিশ্লেষণ',
          ...
          answer: 'দেওয়া আছে, ভর m = ৮০০ কেজি, আদিবেগ u = ০ m/s, ত্বরণ a = ২ m/s², সময় t = ৫ সেকেন্ড।\n\n১. শেষবেগ নির্ণয়:\nv = u + at = ০ + (২ × ৫) = ১০ m/s।\n\n২. প্রযুক্ত বলের মান:\nF = m · a = ৮০০ কেজি × ২ m/s² = ১৬০০ নিউটন (N)।\n\nউত্তরঃ প্রাইভেট কারটির ৫ সেকেন্ড পর শেষবেগ ১০ m/s এবং প্রযুক্ত বল ১৬০০ নিউটন।'
        }
      ]
    }
  ],
      ...
      questions: [
        {
          ...
          answer: 'অণু গঠনকালে কোনো পরমাণু তার সর্ববহিঃস্থ শক্তিস্তরে ৮টি ইলেকট্রন ধারণ করে নিষ্ক্রিয় গ্যাসের ইলেকট্রন বিন্যাস অর্জনের প্রবণতাকে অষ্টক নিয়ম বলে।'
        },
        {
          tag: 'খ',
          type: 'অনুধাবনমূলক',
          marks: 4,
          question: 'সোডিয়ামের (Na) ১ম আয়নীকরণ শক্তি ম্যাগনেসিয়ামের (Mg) চেয়ে কম কেন? ব্যাখ্যা করো।',
          answer: 'সোডিয়ামের (Na-11) সর্ববহিঃস্থ স্তরে ১টি ইলেকট্রন থাকে যা সহজে অপসারিত হয়ে নিষ্ক্রিয় গ্যাস নিয়নের স্থিতিশীল কাঠামো অর্জন করে। অন্যদিকে ম্যাগনেসিয়ামের (Mg-12) বহিঃস্তরে 3s² পূর্ণ অরবিটাল থাকায় সেখান থেকে ইলেকট্রন অপসারণ করতে অধিক শক্তির প্রয়োজন হয়। তাই সোডিয়ামের আয়নীকরণ শক্তি কম।'
        },
        {
          tag: 'গ',
          type: 'প্রয়োগ ও উচ্চতর দক্ষতা',
          marks: 4,
          question: 'X এবং Y এর মধ্যে কোন ধরনের রাসায়নিক বন্ধন গঠিত হবে? ডায়াগ্রামসহ ব্যাখ্যা করো।',
          answer: '১. মৌলদ্বয়ের পরিচয় ও বিন্যাস:\nX (পারমাণবিক সংখ্যা ১১) = সোডিয়াম (Na: 2, 8, 1)\nY (পারমাণবিক সংখ্যা ১৭) = ক্লোরিন (Cl: 2, 8, 7)\n\n২. বন্ধন গঠন প্রক্রিয়া:\nসোডিয়াম পরমাণু তার সর্ববহিঃস্থ স্তরের ১টি ইলেকট্রন ত্যাগ করে ধনাত্মক সোডিয়াম ক্যাটায়নে (Na⁺: 2, 8) পরিণত হয়। অপরদিকে ক্লোরিন পরমাণু সেই নির্গত ইলেকট্রনটি গ্রহণ করে ঋণাত্মক ক্লোরাইড অ্যানায়নে (Cl⁻: 2, 8, 8) পরিণত হয়。\n\nNa → Na⁺ + e⁻\nCl + e⁻ → Cl⁻\n\nবিপরীতধর্মী Na⁺ এবং Cl⁻ আয়নদ্বয় তীব্র স্থির তড়িৎ আকর্ষণ বলের মাধ্যমে পরস্পরের সাথে যুক্ত হয়ে ‘আয়নিক বন্ধন’ (Ionic Bond) তৈরি করে সোডিয়াম ক্লোরাইড (NaCl) অণু গঠন করে।'
        }
      ]
    }
  ],
      ...
      questions: [
        {
          ...
          answer: 'ATP-এর পূর্ণরূপ হলো Adenosine Triphosphate (এডিনোসিন ট্রাইফসফেট)।'
        },
        {
          tag: 'খ',
          type: 'অনুধাবনমূলক',
          ...
          answer: 'শ্বসন প্রক্রিয়ার সবচেয়ে গুরুত্বপূর্ণ ও সর্বাধিক শক্তি উৎপাদনকারী ধাপগুলো (যেমন: ক্রেবস চক্র ও ইলেকট্রন ট্রান্সপোর্ট সিস্টেম) মাইটোকনড্রিয়ার অভ্যন্তরে সম্পন্ন হয়। ১ অণু গ্লুকোজ জারিত হয়ে উৎপাদিত মোট ৩৮টি ATP-র অধিকাংশই মাইটোকনড্রিয়ায় তৈরি ও সঞ্চিত থাকে। তাই একে কোষের শক্তিঘর বা পাওয়ার হাউস বলে।'
        },
        {
          tag: 'গ',
          type: 'উচ্চতর দক্ষতা',
          marks: 4,
          question: 'উদ্দীপকের অঙ্গাণু-A সমগ্র জীবজগতের অস্তিত্ব রক্ষায় কীভাবে ভূমিকা রাখে? বিশ্লেষণ করো।',
          answer: 'উদ্দীপকের অঙ্গাণু-A হলো ‘ক্লোরোপ্লাস্ট’ (Chloroplast)। সমগ্র জীবজগতের অস্তিত্ব রক্ষায় এর ভূমিকা অপরিহার্য:\n\n১. খাদ্য উৎপাদন: সবুজ উদ্ভিদ ক্লোরোপ্লাস্টের সহায়তায় সালোকসংশ্লেষণ প্রক্রিয়ায় সূর্যালোক ও CO₂ ব্যবহার করে শর্করা খাদ্য তৈরি করে, যা প্রত্যক্ষ বা পরোক্ষভাবে সমগ্র প্রাণীজগতের একমাত্র খাদ্যের উৎস।\n২. অক্সিজেন সরবরাহ: এ প্রক্রিয়ায় উপজাত হিসেবে যে অক্সিজেন (O₂) নির্গত হয়, তা গ্রহণ করে পৃথিবীর সকল জীব শ্বাসকার্য পরিচালনা করে বেঁচে থাকে।\n৩. পরিবেশের ভারসাম্য: ক্ষতিকর CO₂ গ্যাস শোষণ করে বায়ুমণ্ডলের অক্সিজেন ও কার্বন ডাই-অক্সাইডের ভারসাম্য রক্ষা করে।\nসুতরাং, ক্লোরোপ্লাস্ট না থাকলে পৃথিবীতে প্রাণের কোনো অস্তিত্বই থাকত না।'
        }
      ]
    }
  ],
